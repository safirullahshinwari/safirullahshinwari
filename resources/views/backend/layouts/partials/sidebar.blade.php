                 ...
                 <ul class="metismenu" id="menu">
                     ...
                     <li>
                         ...
                         <ul
                             ...
                             <li
                                 class="{{ Route::is('admin.users.index')  || Route::is('admin.admins.edit') ? 'active' : '' }}">
                             ...
                             <li class="{{ Route::is('admin.users.create')  ? 'active' : '' }}"><a
                                     href="{{ route('admin.users.create') }}">Create Admin</a></li>
                             @endif
                         </ul>
                     </li>
                     @endif
                     @if ($usr->can('blog.view') || $usr->can('blog.edit') || $usr->can('blog.create') ||
                     $usr->can('blog.delete'))
                     <li>
                         <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-user"></i><span>
                                 Posts
                         ...
                         <ul
                             ...
                             <li
                                 ...
                                 <a href="{{ route('admin.users.index') }}">All Blog Posts</a>
                             </li>
                             @endif

                             @if ($usr->can('blog.create'))
                             <li class="{{ Route::is('admin.users.create')  ? 'active' : '' }}"><a
                                     href="{{ route('admin.users.create') }}">Create Blog Post</a></li>
                             @endif
                         </ul>
                     </li>
                     @endif
                     <li>
                         <a href="{{ route('tickets.index') }}"><i class="fa fa-tasks"></i><span>
                             </span>Tickets</a>
                         <ul
                             class="collapse {{ Route::is('admin.admins.create') || Route::is('admin.admins.index') || Route::is('admin.admins.edit') || Route::is('admin.admins.show') ? 'in' : '' }}">

                             <li class="{{ Route::is('tickets.index')  ? 'active' : '' }}"><a
                                     href="{{ route('tickets.index') }}">All Tickets</a></li>


                             <li class="{{ Route::is('admin.tickets.create')  ? 'active' : '' }}"><a
                                     href="{{ route('admin.tickets.create') }}">Create Tickets</a></li>
